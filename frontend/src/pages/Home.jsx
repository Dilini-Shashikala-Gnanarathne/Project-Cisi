        ...
        <section>
          <div className='container'>
            <div className='lg:w-[470px] mx-auto'>
              ...
              <p className='text-center text__para'>World-class care for everyone. Our health system offers unmatched, expert health care</p>
            </div>

            
            <div className='grid grid-cols-1 gap-5 md:grid-flow-col-2 lg:grid-cols-3 lg:gap-[30px] mt-[30px] lg:mt-[55px]'>
              <div className='py-[30px] px-5'>
                ...
                <div className='mt-[30px]'>
                  <h2 className='text-[26px] leading-9 text-headingColor front-[700] text-center'>Find a Doctor
                  </h2>
                  <p className='text-[16px] leading-7 text-textColor font-[400] mt-4 text-center '>World-class care for everyone. Our health system 
                  offers unmatched, expert health care</p>
                  <Link to='/doctors' className='w-[44px] h-[44px] rounded-full borde border-solid border-[#181A1E] mt-[30px] 
              ...
              <div className='py-[30px] px-5'>
                ...
                <div className='mt-[30px]'>
                  <h2 className='text-[26px] leading-9 text-headingColor front-[700] text-center'>
                    Find a Location
                  </h2>
                  <p className='text-[16px] leading-7 text-textColor font-[400] mt-4 text-center '>World-class care for everyone. Our health system 
                  offers unmatched, expert health care</p>
                  <Link to='/doctors' className='w-[44px] h-[44px] rounded-full borde border-solid border-[#181A1E] mt-[30px] mx-auto flex items-center justify-center group hover:bg-primaryColor hover:border-none'>
                    <BsArrowRight className='w-6 h-5 group-hover:text-white'/>
                  </Link>
                  </div>              
              </div>
          ...
          <div className="container">
            <div className='flex flex-col items-center justify-between lg:flex-row'>
              ...
              <div className="xl:w-[670px]">
                ...
                <ul className="pl-4">
                  <li className="text__para">1. Schedule the aapointment directly.  
                  </li> 
