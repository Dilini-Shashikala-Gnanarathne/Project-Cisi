  ...
  return (
    <div className='shadow-panelShadow p-3 lg:p-5 rounded-md'>
        <div className="flex items-center justify-between">
            <p className='text-[18px] leading-[30px]font-[400] text-textColor mt-[18px]  font-semibold'> Ticket Price</p>
            <span className='text-[16px] leading-7 lg:text-[22px] lg:leading-8 text-headingColor font-bold'>
                500 BDT
            </span>
        </div>
        <div className="mt-[30px]">
            <p className='text-[18px] leading-[30px]font-[400] text-textColor mt-[18px]  font-semibol'>Available Time Slots</p>
            <ul className='mt-3'>
